# Walkthru Earth AUC P1

Walkthru.earth talk for AUC, P1. Cloned from the canonical `walkthru-earth-intro` deck, which is the design baseline that other talks copy from, featuring our brand colors, Quicksand typography, and earth-toned aesthetic.
